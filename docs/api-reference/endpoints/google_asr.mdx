...
- `rate` (optional): Sample rate in Hz (default: 16000)
- `language` (optional): Language code (e.g., "en-US", "id-ID", "tr-TR")

**Response Format:**
```json
{
  "asr_reply": "transcribed text here"
}
```

**Note:** The HTTP endpoint returns 404. Use WebSocket endpoint for ASR functionality. 
